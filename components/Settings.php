...
class Settings extends Component
{
     ...
     */
    public $modelClass = 'meshzp\rbacadmin\models\Setting';
     ...
     */
    public $cacheKey = 'rbacadmin/settings';
    ...
    /**
     * Gets the value for the given key and section.
    ...
    /**
     * Sets the value for the given key and section.
     *
     * @param $key
     * @param $value
     * @param null $section
